...
function PlacesLocation(props) {
    ...
    () => {
        ...
        props.setSearchLatitude(lat),
        props.setSearchLongitude(lng)
        });
    };

    useEffect(() => {
        if(props.searchLatitude && props.searchLatitude) {
            console.log(`Retrieved ${props.searchLatitude} and ${props.searchLongitude}`)
        }
